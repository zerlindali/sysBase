...
public class CryptRSA {
    ...
    private String signatrue_algorithm;
    
    public CryptRSA(){
    	this.signatrue_algorithm = SIGNATURE_ALGORITHM_SHA1;
    }
    
    public CryptRSA(String signatureMethod){
    	this.signatrue_algorithm = signatureMethod;
